...
export default function SectionsAnalyticsPage() {
  ...
  return <div className="space-y-6">
    ...
    <Card data-tour="page-section-filters"><CardContent className="space-y-3 pt-6"><div className="flex flex-wrap gap-2">
    ...
    <Card data-tour="page-section-actions"><CardHeader className="flex-row items-center justify-between"><div><CardTitle className="text-base">Lớp cần xử lý trước</CardTitle><p className="mt-1 text-xs text-muted-foreground">Xếp theo mức rủi ro, số lượt trượt và thiếu điểm.</p></div>{data ? <Badge variant="outline">{data.pagination.total} lớp</Badge> : null}</CardHeader><CardContent>
