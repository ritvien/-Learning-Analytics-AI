...
import {
  AlertTriangle, ChevronLeft, ChevronRight, ChevronRight as BreadcrumbArrow, RefreshCw,
  Search, SlidersHorizontal, TriangleAlert, Users,
} from "lucide-react"
import {
  Bar, BarChart, CartesianGrid, Cell, Legend, Pie, PieChart, ResponsiveContainer,
  ReferenceLine, Scatter, ScatterChart, Tooltip, XAxis, YAxis, ZAxis,
} from "recharts"
...
import {
  parseAnalyticsFilters, serializeAnalyticsFilters, validateAnalyticsDateRange,
  type AnalyticsFilterState,
} from "@/lib/analytics-filters"
import {
  api, type ApiCourse, type ApiDashboardSections, type ApiDepartment, type ApiProgram,
  type ApiSemester, type ApiTeacher, type ApiUser,
} from "@/lib/api"
import {
  dataQualitySummary,
