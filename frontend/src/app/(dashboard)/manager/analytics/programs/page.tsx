  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card><CardHeader><CardTitle className="text-sm">Pass rate của ngành qua học kỳ</CardTitle></CardHeader><CardContent><ResponsiveContainer width="100%" height={240}><LineChart data={data.trend}><CartesianGrid strokeDasharray="3 3" /><XAxis dataKey="semester" tick={{ fontSize: 10 }} /><YAxis domain={[0, 100]} tickFormatter={value => `${value}%`} /><Tooltip formatter={(value: any) => [`${value}%`, "Pass rate"]} /><Line dataKey="passRate" stroke="#16a34a" strokeWidth={2.5} /></LineChart></ResponsiveContainer></CardContent></Card>
